...
public class EditCustomerPageObjects extends AbstractPage {
	...
	public boolean isCustomerIDErrorMessageDisplayed(String option) {
		...
		try {
			switch (option) {
			case "blank":
				a = driver.findElement(By.xpath(EditCustomerPageUI.ID_NULL_ERROR_MESSAGE)).isDisplayed();
				break;
			case "character":
				a = driver.findElement(By.xpath(EditCustomerPageUI.ID_CHARACTER_ERROR_MESSAGE)).isDisplayed();
				break;
			case "special character":
				a = driver.findElement(By.xpath(EditCustomerPageUI.ID_SPECIAL_CHAR_ERROR_MESSAGE)).isDisplayed();
				break;
			case "first blank":
				a = driver.findElement(By.xpath(EditCustomerPageUI.ID_FIRST_CHAR_BLANK_ERROR_MESSAGE)).isDisplayed();
				break;
			}
	...
	public boolean isAddressErrorMessageDisplayed(String option) {
		...
		switch (option) {
		case "blank":
			a = driver.findElement(By.xpath(EditCustomerPageUI.ADDRESS_BLANK_ERROR)).isDisplayed();
			break;
		}
		return a;
	}
	...
	public boolean isCityErrorMessageDisplayed(String option) {
		...
		switch (option) {
		case "blank":
			a = driver.findElement(By.xpath(EditCustomerPageUI.CITY_BLANK_ERROR)).isDisplayed();
			break;
		case "character":
			a = driver.findElement(By.xpath(EditCustomerPageUI.CITY_NUMERIC_ERROR)).isDisplayed();
			break;
		case "special character":
			a = driver.findElement(By.xpath(EditCustomerPageUI.CITY_SPECIAL_CHAR_ERROR)).isDisplayed();
			break;
		}
		return a;
	}
	...
	public boolean isStateErrorMessageDisplayed(String option) {
		...
		switch (option) {
		case "blank":
			a = driver.findElement(By.xpath(EditCustomerPageUI.STATE_BLANK_ERROR)).isDisplayed();
			break;
		case "numeric":
			a = driver.findElement(By.xpath(EditCustomerPageUI.STATE_NUMERIC_ERROR)).isDisplayed();
			break;
		case "special character":
			a = driver.findElement(By.xpath(EditCustomerPageUI.STATE_SPECIAL_CHAR_ERROR)).isDisplayed();
			break;
		}
		return a;
	}
	...
	public boolean isPinErrorMessageDisplayed(String option) {
		...
		switch (option) {
		case "blank":
			a = driver.findElement(By.xpath(EditCustomerPageUI.PIN_BLANK_ERROR)).isDisplayed();
			break;
		case "character":
			a = driver.findElement(By.xpath(EditCustomerPageUI.PIN_CHAR_ERROR)).isDisplayed();
			break;
		case "special character":
			a = driver.findElement(By.xpath(EditCustomerPageUI.PIN_SPECIAL_CHAR_ERROR)).isDisplayed();
			break;
		case "6 digits":
			a = driver.findElement(By.xpath(EditCustomerPageUI.PIN_SIX_DIGIT_ERROR)).isDisplayed();
			break;
		}
		return a;
	}
	...
	public boolean isPhoneErrorMessageDisplayed(String option) {
		...
		switch (option) {
		case "blank":
			a = driver.findElement(By.xpath(EditCustomerPageUI.PHONE_BLANK_ERROR)).isDisplayed();
			break;
		case "special character":
			a = driver.findElement(By.xpath(EditCustomerPageUI.PHONE_SPECIAL_CHAR_ERROR)).isDisplayed();
			break;
		}
		return a;
	}
	...
	public boolean isEmailErrorMessageDisplayed(String option) {
		...
		switch (option) {
		case "blank":
			a = driver.findElement(By.xpath(EditCustomerPageUI.EMAIL_BLANK_ERROR)).isDisplayed();
			break;
		case "format":
			a = driver.findElement(By.xpath(EditCustomerPageUI.EMAIL_FORMAT_ERROR)).isDisplayed();
			break;
		}
		return a;
	}
	...
	public void clearTextInTextbox(String textbox) {
		switch (textbox) {
		case "customer id":
			clearText(driver, EditCustomerPageUI.CUSTOMER_ID_TEXTBOX);
			break;
		case "address":
			clearText(driver, EditCustomerPageUI.ADDRESS_TEXTAREA);
			break;
		case "city":
			clearText(driver, EditCustomerPageUI.CITY_TEXTBOX);
			break;
		case "state":
			clearText(driver, EditCustomerPageUI.STATE_TEXTBOX);
			break;
		case "pin":
			clearText(driver, EditCustomerPageUI.PIN_TEXTBOX);
			break;
		case "mobile number":
			clearText(driver, EditCustomerPageUI.MOBILE_TEXTBOX);
			break;
		case "email":
			clearText(driver, EditCustomerPageUI.EMAIL_TEXTBOX);
			break;
		}
	}
